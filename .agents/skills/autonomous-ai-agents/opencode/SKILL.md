...
- In WSL with Windows-global npm install, direct `opencode` can fail with missing Linux platform package errors; invoke via Windows PowerShell path in that setup.
