...
- [email protected] â†’ true
- invalid â†’ false
- [email protected] â†’ false
- user@domain â†’ false
- @domain.com â†’ false
...
- "abc" â†’ weak (too short)
- "password123" â†’ weak (common pattern)
- "MyP@ssw0rd!" â†’ strong (mixed case, numbers, symbols, 10+ chars)
- "abcdefghij" â†’ medium (long but no variety)
...
- "2024-01-15" â†’ Date object for Jan 15, 2024
- "01/15/2024" â†’ Date object for Jan 15, 2024
- "January 15, 2024" â†’ Date object for Jan 15, 2024
- "invalid" â†’ null
- "" â†’ null
