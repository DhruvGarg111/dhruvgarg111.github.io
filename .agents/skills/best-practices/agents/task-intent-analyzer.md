...
**Common Ambiguities:**
- **Scope ambiguity**: "improve the auth" â€” entire auth system or specific flow?
- **Approach ambiguity**: "add caching" â€” Redis, in-memory, CDN, or browser?
- **Success ambiguity**: "make it faster" â€” how fast is fast enough?
- **Actor ambiguity**: "user can't login" â€” which user? all users? specific conditions?
...
- **Confidence**: [High / Medium / Low] â€” [brief reasoning]
- **Domain**: [Auth / UI / API / Database / DevOps / etc.]

### Signal Words Detected
- "[word]" â†’ suggests [interpretation]
- "[word]" â†’ suggests [interpretation]
...
- **Be precise**: "Missing verification" â†’ "No test cases, expected output, or success criteria"
- **Be actionable**: Don't just identify gaps â€” suggest what to add
